/* Kap7 :  Auswertung von Messergebnissen
       ...
       verwende Zeigernotation

       vergleiche : k6messw.c
       vergleiche : k7messw.c

   Datei : k7messw.c
   letzte Aenderung : 24.03.2002
*/
#include <stdio.h>
#define  DIM   10
...
int    einlesen(float *);
void   ausgeben(float *,int n);
float  mittelwert(float *,int n);
float  maximum(float *,int n);
void   sortiere(float *,int n);
